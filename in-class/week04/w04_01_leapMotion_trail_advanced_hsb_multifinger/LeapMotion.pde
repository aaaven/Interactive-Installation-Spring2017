...
void LeapDraw() {
  ...
  for (Hand hand : leap.getHands ()) {
    ...
    finger[0] = new PVector(finger_thumb.getPosition().x, 
      finger_thumb.getPosition().y);
      
    finger[1] = new PVector(finger_index.getPosition().x, 
      finger_index.getPosition().y);

    finger[2] = new PVector(finger_middle.getPosition().x, 
      finger_middle.getPosition().y);

    finger[3] = new PVector(finger_ring.getPosition().x, 
      finger_ring.getPosition().y);

    finger[4] = new PVector(finger_pink.getPosition().x, 
      finger_pink.getPosition().y);
